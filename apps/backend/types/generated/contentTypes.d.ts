...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    content: Schema.Attribute.DynamicZone<
      ['components.headline', 'components.paragraph', 'components.image']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiCertificationCertification
  ...
  attributes: {
    ...
    issuedBy: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footer: Schema.Attribute.Component<'globals.footer', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    header: Schema.Attribute.Component<'globals.header', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiMarketStatisticMarketStatistic
  extends Struct.CollectionTypeSchema {
  collectionName: 'market_statistics';
  info: {
    description: '';
    displayName: 'marketStatistic';
    pluralName: 'market-statistics';
    singularName: 'market-statistic';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    source: Schema.Attribute.DynamicZone<['components.bar-stat']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
  ...
  attributes: {
    content: Schema.Attribute.DynamicZone<
      [
        ...
        'sections.competitive-adventage-section',
        'sections.market-challenge-section',
        'sections.partnership-values-section',
        'sections.talent-solutions-section',
        'sections.international-access-section',
        'sections.testimonials-section',
        'sections.road-map-section',
        'sections.inspiration-quote-section',
        'sections.insights-section',
        'sections.business-benefits-section',
        'sections.overview-section',
        'sections.section-certifications',
      ]
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    publish_ad: Schema.Attribute.DateTime &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::market-statistic.market-statistic': ApiMarketStatisticMarketStatistic;
